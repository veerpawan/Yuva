...
public class OTP_Screen extends AppCompatActivity {
    String otpKey, status;
    protected static int otpStatus = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ContextCompat.checkSelfPermission(OTP_Screen.this, Manifest.permission.INTERNET);
        final EditText eTxtOTP = (EditText) findViewById(R.id.editTextOTP);
        Button bOTP = (Button) findViewById(R.id.btnOTP);
        Intent ii = getIntent();
        otpKey = ii.getStringExtra("OTP_Key");
        sharedPreferences = getSharedPreferences("MyPrefs", 0);

        progressBar = new ProgressDialog(OTP_Screen.this);
        progressBar.setCancelable(true);
        progressBar.setMessage("Waiting for OTP Key ...");
        ...
        new CountDownTimer(10 * 1000, 1000) {
            ...
            public void onFinish() {
                progressBar.dismiss();
                eTxtOTP.setText(otpKey);
                Log.e("OTP_in_screen", otpKey);
                otpStatus = 1;
                //        Intent intent = new Intent(getApplicationContext(), OpportunitiesList.class);
                //finish();
...
/*
        int count_s = sharedPreferences.getInt("progressBarStatus",0);
        Log.e("count_s", count_s + "");
        if(count_s==100) {
            eTxtOTP.setText(count_s+"");
            Log.e("OTP_in_screen", otpKey);
        }
        eTxtOTP.setText("hello");
        Log.e("OTP_in_screen", otpKey);
*/
            ...
            try {
                ...
                */
                ...
                if (success == 1) {
                    ...
                    editor.commit();
                    Intent intent = new Intent(OTP_Screen.this, Home.class);
...
//            if (message.equals("1")) {
            Snackbar snackbar = Snackbar.make(findViewById(android.R.id.content), "Welcome-NIIT Yuva Jyoti Career Opportunites App  ", Snackbar.LENGTH_LONG);
